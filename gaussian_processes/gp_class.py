...
from gaussian_processes.gp_functions import gp_exact_moment, gp_taylor_approx, gp
from gaussian_processes.gp_functions import build_gp, build_TA_cov, get_mean_function
from gaussian_processes.optimize import train_gp, train_gp_numpy
from gaussian_processes.mpc_class import lqr

# from gaussia_processes.gp_functions import gp_exact_moment, gp_taylor_approx, gp
# from gaussia_processes.gp_functions import build_gp, build_TA_cov, get_mean_function
...
class GP:
    ...
    def validate(self, X_test, Y_test):
        ...
        #check out the validation score
        """
...
#TODO: Fix this
    ...
    #        ax.set_ylim([-20,20])
        if title is not None:
            ...
            fig.canvas.setWindowTitle(('Training data: {x},  Mean Function: {y},  '
